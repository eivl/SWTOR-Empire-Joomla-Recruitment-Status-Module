...
$content  .= "            <tr>";
	...
	$content  .= "                                <tbody>";
	$content  .= "                                  <tr>";
	$content  .= "                                    <td><font class=\"content\"><img src=\"modules/mod_recruitment/images/sithwarrior.png\" border=\"0\"></font></td>";
	...
	$content  .= "                                <tbody>";
	$content  .= "                                  <tr>";
	$content  .= "                                    <td><font class=\"content\"><img src=\"modules/mod_recruitment/images/sithinquisitor.png\" border=\"0\"></font></td>";
	...
	$content  .= "                                <tbody>";
	$content  .= "                                  <tr>";
	$content  .= "                                    <td><font class=\"content\"><img src=\"modules/mod_recruitment/images/bountyhunter.png\" border=\"0\"></font></td>";
	...
	$content  .= "                                <tbody>";
	$content  .= "                                  <tr>";
	$content  .= "                                    <td><font class=\"content\"><img src=\"modules/mod_recruitment/images/imperialagent.png\" border=\"0\"></font></td>";
